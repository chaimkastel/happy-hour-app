            ...
            {!isScanning ? (
              <div className="text-center">
                ...
                <div className="mt-6 max-w-md mx-auto">
                  <div className="text-gray-500 text-sm mb-2">Or enter voucher code manually</div>
                  <form
                    onSubmit={(e) => { e.preventDefault(); setCurrentRedemption(mockQRData); }}
                  ...
                  >
                    ...
                    />
                    <button type="submit" className="px-4 py-2 bg-green-600 text-white rounded-lg">Validate</button>
                  </form>
                </div>
              </div>
            ) : (
