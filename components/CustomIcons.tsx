...
export function FireIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2C8.5 2 6 4.5 6 8c0 2.5 1.5 4.5 3 6l3 3 3-3c1.5-1.5 3-3.5 3-6 0-3.5-2.5-6-6-6zm0 2c2.2 0 4 1.8 4 4 0 1.5-.8 2.8-2 3.5L12 15l-2-3.5c-1.2-.7-2-2-2-3.5 0-2.2 1.8-4 4-4z"/>
    </svg>
  );
}
...
export function CrownIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5zm2.7-2h8.6l.9-5.4L14 12l-2-4-2 4-3.2-3.4L7.7 14z"/>
    </svg>
  );
}
...
export function DiamondIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M6 2L2 7l10 13 10-13-4-5H6zm2.03 2H15.97l2.34 3H9.69L8.03 4zM12 17.27L4.5 9h15L12 17.27z"/>
    </svg>
  );
}
...
export function TimerIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function CreditCardIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
